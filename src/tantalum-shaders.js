var Shaders = {
    ...
    'scene40-ku-semi-rough-4xsmall':
        ...
        '    lineIntersect(ray, vec2(0.4025, -0.009999999999999735), vec2(0.3975, -0.0049' +
                                                       '99999999999735), 0.0, isect);\n'   +
        '    lineIntersect(ray, vec2(0.3975, -0.004999999999999735), vec2(0.4025, 2.65412' +
                                                       '6918244515e-16), 0.0, isect);\n'   +
        '    lineIntersect(ray, vec2(0.4025, 2.654126918244515e-16), vec2(0.3975, 0.00500' +
                                                       '00000000002655), 0.0, isect);\n'   +
    ...
    'scene39-ku-semi-rough-2xsmall':
        ...
        '    lineIntersect(ray, vec2(0.395, -0.009999999999999802), vec2(0.405, 1.9775847' +
                                                          '6261356e-16), 0.0, isect);\n'   +
        '    lineIntersect(ray, vec2(0.405, 1.97758476261356e-16), vec2(0.395, 0.01000000' +
